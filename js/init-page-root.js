// ================================================================
//  init-page-root.js - الإصدار النهائي (الدرع المطلق + v4.1 Fix + تحسين الحقن)
// ================================================================

(function() {
  'use strict';
  console.log('🛡️ [init] تفعيل الدرع المطلق (v4.1 مع تحسين الحقن)...');
  ...
  // ===== [تحسين جديد] حقن الهيدر بعد <head> مباشرة =====
  ...
  // ================================================================
  //  🚨 كاشف 404 التلقائي + معالجته (تم إرجاع النسخة الأصلية)
  // ================================================================
  ...
  console.log('✅ init-page-root.js جاهز (النسخة النهائية v4.1 مع تحسين الحقن)');
})();