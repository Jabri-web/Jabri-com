// ================================================================
//   service-worker.js - v6.0 (نظام إصدارات + تحكم كامل)
...
//                    ^^^^^^^^^^^^^^^^^^^^^
//  v6.0  → تحديث فوري (مع رسالة للمستخدم) - بعد تغيير Page12 إلى logo

// ================================================================
//  📦 الملفات المخزّنة (الرئيسية + الصفحات الأساسية فقط)
// ================================================================
